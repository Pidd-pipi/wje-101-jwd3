...
const (
	...
	LogBeanFavoriteSuccess     = "coffee bean favorited: id=%d"
	LogBeanFavoriteFailed      = "coffee bean favorite failed: id=%d"
	LogBeanUnfavoriteSuccess   = "coffee bean unfavorited: id=%d"
	LogBeanUnfavoriteFailed    = "coffee bean unfavorite failed: id=%d"
	LogBeanFavoriteListSuccess = "coffee bean favorite list success: user_id=%d"
